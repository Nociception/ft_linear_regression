...
help:
	...
	@echo "  Both have:"
	@echo "     - a '--help' option for more details."
	@echo "     - a '--bonus' option for visualisation."
	@echo "  1. Train your model by running 'python3 train.py'."
	@echo "     - This creates the 'model.txt' file."
	@echo ""
	@echo "  2. Use the trained model (by reading the 'model.txt' file) to predict a car's price with 'predict.py'."
